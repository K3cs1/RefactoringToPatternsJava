...
public class CapitalCalculationTests {
  ...
  public void test_term_loan_with_risk_adjusted_capital_strategy() {
    Loan loan =
        new Loan(
            _riskAdjustedCapitalStrategy, Commitment, Outstanding, RiskRating, _maturity, null);

    Assert.assertThat(
        loan.GetCapitalStrategy(), new IsInstanceOf(RiskAdjustedCapitalStrategy.class));
  }
}
